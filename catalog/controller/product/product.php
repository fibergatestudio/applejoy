	...
	public function index() {
		...
		if ($product_info) {
			...
			if (!is_null($product_info['special']) && (float)$product_info['special'] >= 0) {
				$data['special'] = $special = $this->currency->format($this->tax->calculate($product_info['special'], $product_info['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']);
				$data['procent'] = $this->model_catalog_product->procent_calculate($product_info);
