<div class="ocf-value-list">
  ...
  <div class="ocf-input-group ocf-slider-input-group">
    ...
    <?php } ?>
    <input type="tel" name="ocf[<?php echo $filter['id']; ?>][min]" value="<?php echo $filter['min_request']; ?>" class="ocf-form-control" id="ocf-input-min-<?php echo $filter['id']; ?>" autocomplete="off" <?php echo (!$filter['slider_enabled'] ? 'disabled="disabled"' : ''); ?> />
    <?php if ($filter['type'] == 'slide_dual') { ?>
    <span class="ocf-input-group-addon">-</span>
    <input type="tel" name="ocf[<?php echo $filter['id']; ?>][max]" value="<?php echo $filter['max_request']; ?>" class="ocf-form-control" id="ocf-input-max-<?php echo $filter['id']; ?>" autocomplete="off" <?php echo (!$filter['slider_enabled'] ? 'disabled="disabled"' : ''); ?> />
    <?php } ?>
