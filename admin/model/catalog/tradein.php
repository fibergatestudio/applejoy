...
class ModelCatalogTradein extends Model
{
    public function addDeviceDB($data){

        $this->db->query(
            "INSERT INTO " .
                DB_PREFIX .
                "tradein_devices SET device_type = '" .
                $data["device_type"] .
                "', `device_name` = '" .
                $data["device_name"] .
                "', `device_gb` = '" .
    ...
    public function deleteCategory($category_id)
    {
        ...
        $this->db->query(
            "DELETE FROM " .
                DB_PREFIX .
                "product_to_category WHERE category_id = '" .
                (int) $category_id .
                "'"
        );
        ...
        $this->db->query(
            "DELETE FROM " .
                DB_PREFIX .
                "coupon_category WHERE category_id = '" .
                (int) $category_id .
                "'"
        );
    ...
    {
        $query = $this->db->query(
            "SELECT DISTINCT *, (SELECT GROUP_CONCAT(cd1.name ORDER BY level SEPARATOR '&nbsp;&nbsp;&gt;&nbsp;&nbsp;') FROM " .
                DB_PREFIX .
                "category_path cp LEFT JOIN " .
                DB_PREFIX .
                "category_description cd1 ON (cp.path_id = cd1.category_id AND cp.category_id != cp.path_id) WHERE cp.category_id = c.category_id AND cd1.language_id = '" .
                (int) $this->config->get("config_language_id") .
                "' GROUP BY cp.category_id) AS path FROM " .
                DB_PREFIX .
                "category c LEFT JOIN " .
                DB_PREFIX .
                "category_description cd2 ON (c.category_id = cd2.category_id) WHERE c.category_id = '" .
                (int) $category_id .
                "' AND cd2.language_id = '" .
                (int) $this->config->get("config_language_id") .
                "'"
    ...
    {
        $sql =
            "SELECT cp.category_id AS category_id, GROUP_CONCAT(cd1.name ORDER BY cp.level SEPARATOR '&nbsp;&nbsp;&gt;&nbsp;&nbsp;') AS name, c1.parent_id, c1.sort_order FROM " .
            DB_PREFIX .
            "category_path cp LEFT JOIN " .
            DB_PREFIX .
            "category c1 ON (cp.category_id = c1.category_id) LEFT JOIN " .
            DB_PREFIX .
            "category c2 ON (cp.path_id = c2.category_id) LEFT JOIN " .
            DB_PREFIX .
            "category_description cd1 ON (cp.path_id = cd1.category_id) LEFT JOIN " .
            DB_PREFIX .
    ...
    {
        $query = $this->db->query(
            "SELECT category_id, path_id, level FROM " .
                DB_PREFIX .
                "category_path WHERE category_id = '" .
                (int) $category_id .
                "'"
    ...
    public function getCategorySeoUrls($category_id)
    {
        ...
        foreach ($query->rows as $result) {
            $category_seo_url_data[$result["store_id"]][
                $result["language_id"]
            ] = $result["keyword"];
        }
    ...
    {
        $query = $this->db->query(
            "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "category"
        );
    ...
    public function getTotalCategoriesByLayoutId($layout_id)
    {
        $query = $this->db->query(
            "SELECT COUNT(*) AS total FROM " .
                DB_PREFIX .
                "category_to_layout WHERE layout_id = '" .
                (int) $layout_id .
                "'"
        );
