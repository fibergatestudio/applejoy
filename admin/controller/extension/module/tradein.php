<?php
class ControllerExtensionModuleTradein extends Controller {

	private $error = array();

  public function install() {
  	//Create table tradein
    $this->db->query("CREATE TABLE IF NOT EXISTS `".DB_PREFIX."tradein` (
	...
	public function index() {
		$this->load->language('extension/module/tradein');
