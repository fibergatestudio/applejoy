      ...
      <div class="<?php echo $class; ?>">
        ...
        <div class="dropdown ocf-product-values-dropdown">
          ...
          <ul class="dropdown-menu ocf-filter-dm">
            ...
            <li class="active"><a href="#"><input type="checkbox" name="ocfilter_filter[<?php echo $filter['filter_key']; ?>][]" value="<?php echo $value['value_id']; ?>" checked="checked" autocomplete="off" /> <span><?php echo $value['name']; ?><?php echo $filter['suffix']; ?></span></a></li>
            <?php } else { ?>
            <li><a href="#"><input type="checkbox" name="ocfilter_filter[<?php echo $filter['filter_key']; ?>][]" value="<?php echo $value['value_id']; ?>" autocomplete="off" /> <span><?php echo $value['name']; ?><?php echo $filter['suffix']; ?></span></a></li>
            <?php } ?>
            <?php } ?>
          </ul>
        </div>
