...
<div class="form-group">
  ...
  <div class="col-sm-9">
    ...
    <kbd contenteditable="true" onclick="document.execCommand('selectAll', false, null)" style="font-size: 14px;"><span id="cron-period"></span> <?php echo $cron_command_bin; ?> -f <?php echo $cron_command_script; ?></kbd>
...
var getAutoAttributes = function(btn) {
  $(btn).button('loading');
